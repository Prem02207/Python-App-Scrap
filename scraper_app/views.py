...
def search_apps(request):
    ...
    if request.method == "POST":
        ...
        if keyword:
            try:
                # n_hits 10 rakhein taaki response fast aaye
                ...
                for app in apps:
                    ...
                    if min_installs <= installs_count <= max_installs:
                        ...
                        # Scraping logic with strict timeout
                        try:
                            ...
                            print(f"Scrape row error: {e}")  # Debugging ke liye
...
def download_excel(request):
    ...
    try:
        ...
        return HttpResponse(f"Error creating Excel: {str(e)}")